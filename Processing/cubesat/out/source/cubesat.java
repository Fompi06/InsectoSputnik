/* autogenerated by Processing revision 1292 on 2023-06-25 */
...
public void BatHeat(int val) {
  serial.write("1," + PApplet.parseInt(cp5.get(Toggle.class, "CamHeat").getValue()) + "," + val + "," + PApplet.parseInt(cp5.get(Toggle.class, "EcoMode").getValue()) + ";");
}

public void CamHeat(int val) {
  serial.write("1," + val + "," + PApplet.parseInt(cp5.get(Toggle.class, "BatHeat").getValue()) + "," + PApplet.parseInt(cp5.get(Toggle.class, "EcoMode").getValue()) + ";");
}

public void EcoMode(int val) {
  serial.write("1," + PApplet.parseInt(cp5.get(Toggle.class, "CamHeat").getValue()) + "," + PApplet.parseInt(cp5.get(Toggle.class, "BatHeat").getValue()) + "," + val + ";");
}
...
public void keyPressed() {
  ...
  public void settings() { size(1100, 925); }
