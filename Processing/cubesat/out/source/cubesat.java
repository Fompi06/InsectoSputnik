/* autogenerated by Processing revision 1292 on 2023-07-04 */
    ...
    if (str != null)
    {
      ...
      case 0:
        if (data.length == 4) {
          ...
          logger.print("0,");
          logger.print(PApplet.parseFloat(data[1]));
          logger.print(",");
          logger.print(PApplet.parseFloat(data[2]));
          logger.print(",");
          logger.print(PApplet.parseFloat(data[3]));
          logger.println(",");
        }
        break;
      case 1:
        if (data.length == 5) {
          ...
          logger.print(PApplet.parseFloat(data[i]));
          logger.print(",");
          }
          logger.println();
        }
      ...
      case 2:
        if (data.length == 11) {
          ...
          logger.print(",");
          for(int i = 1; i < data.length; i++) {
          logger.print(PApplet.parseInt(data[i]));
          logger.print(",");
          }
          logger.println();
        }
